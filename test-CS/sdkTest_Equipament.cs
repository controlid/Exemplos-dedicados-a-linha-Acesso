...
namespace UnitTestAcesso
{
    ...
    public partial class sdkTest
    {
        ...
        public void sdk_set_Time()
        {
            ...
            Assert.IsTrue(s > 3 && s < 5, "Não foi possivel ler ou definir o horario");
        ...
        public void sdk_TemplateMatch()
        {
            ...
            ErrorResult er = eqpt.TemplateMatch(tr1.template, cOther, tr3.template);
            Console.WriteLine("A) " +er.code + ": " + er.error);
            Assert.IsTrue(er.code != 0, "Deveria ter resultado erro");

            // Tudo certo aqui
            er = eqpt.TemplateMatch(tr1.template, tr2.template, tr3.template);
            Console.WriteLine("B) " + er.code + ": " + er.error);
            Assert.IsTrue(er.code == 0, "Deveria ter dado certo");
        }
        ...
        public void sdk_TemplateCreate()
        {
            ...
            Console.WriteLine("Incluido usuário 44");
            ...
            ErrorResult er = eqpt.TemplateCreate(idU, tr1.template, tr2.template, tr3.template);
            if (er.code != 0)
            {
                Console.WriteLine(er.code + ": " + er.error);
                Assert.Inconclusive(er.code + ": " + er.error);
            }
            else
        ...
        public void sdk_TemplateCreate2()
        {
            ...
            ErrorResult er = eqpt.TemplateCreate(
                idU, 
